    ...
    this.verifyPassword(this.state.currPassword).then(
      u => {
        ...
        this.updatePassword(this.state.newPassword).then(
          u => { 
            this.setState({ success: true, loading: false }); // password verified
          },
          error => {
            this.setState({
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        {/* text fields for old password and new passwords */}
        <TextInput
          secureTextEntry
        ...
        {/* button for submitting change of password */}
        <Button
        ...
        {/* print error message in the event of an error */}
        {errorMessage && !loading && !success && (
          <Text style={styles.errorMessage}>{this.state.errorMessage}</Text>
        )}

        {/* print success message in the event of successful password change */}
